...
public class ParkingLotMapper {
    ...
    public ParkingLot newParkingLotDTOToParkingLot(NewParkingLotDTO newParkingLotDTO) {
        ...
        return new ParkingLot(newParkingLotDTO.getName(),newParkingLotDTO.getCategory(),newParkingLotDTO.getMaxCapacity(), newParkingLotDTO.getPricePerHour(), newContactPerson,newParkingLotDTO.getStreetName(),newParkingLotDTO.getStreetNumber(), newPostalCode);
    }
}
